...
ActiveRecord::Schema.define(version: 2019_11_20_161936) do
...
# Could not dump table "rapidfire_surveys" because of following StandardError
#   Unknown type 'uuid' for column 'api_id'
